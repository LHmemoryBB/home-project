<template>
	<div class="diy_details_box diy_div_integral_products">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/product_exchange/edit','add')" @click="to_form('/product_exchange/edit')" ><span> 兑换</span> </button>
																															<button class="btn btn-primary details_btn" v-if="$check_action('/integral_products/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var integral_products_id = this.obj.integral_products_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "integral_products",
          source_field: "integral_products_id",
          source_id: integral_products_id
        }, (res) => {
