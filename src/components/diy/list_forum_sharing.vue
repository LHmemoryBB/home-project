<template>
	<div class="diy_home diy_list diy_forum_sharing" id="diy_forum_sharing_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/forum_sharing/details?forum_sharing_id=' + o['forum_sharing_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/forum_sharing/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/forum_sharing/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','share_title','/forum_sharing/list')">
					分享标题
				</th>
										<th class="diy_title" v-if="$check_field('get','sharing_categories','/forum_sharing/list')">
					分享类别
				</th>
													<th class="diy_title" v-if="$check_field('get','cover_photo','/forum_sharing/list')">
					封面图片
				</th>
								</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
								<td class="diy_field diy_text" v-if="$check_field('get','share_title','/forum_sharing/list')">
						<span>
							{{ o["share_title"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','sharing_categories','/forum_sharing/list')">
						<span>
							{{ o["sharing_categories"] }}
						</span>
					</td>
														<td class="diy_field" v-if="$check_field('get','cover_photo','/forum_sharing/list')">
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                ...
                <div  v-for="(o, i) in  list" :key="i" class="slide" >
                    ...
                    <router-link :to="'/forum_sharing/details?forum_sharing_id=' + o['forum_sharing_id']" class="lis_cont">
                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/forum_sharing/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/forum_sharing/details?forum_sharing_id="+v.forum_sharing_id)
			},
