<template>
	<div class="diy_details_box diy_div_attraction_information">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/attraction_reservation/edit','add')" @click="to_form('/attraction_reservation/edit')" ><span> 预约景点</span> </button>
																											<button class="btn btn-primary details_btn" v-if="$check_action('/attraction_information/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/attraction_information/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
              ...
              var praise_len = _this.praiseLen;
							this.$post('~/api/attraction_information/set?attraction_information_id=' + _this.obj["attraction_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var attraction_information_id = this.obj.attraction_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "attraction_information",
          source_field: "attraction_information_id",
          source_id: attraction_information_id
        }, (res) => {
