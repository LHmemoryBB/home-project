        ...
        <div class="row row_det">
          ...
          <div class="details_btn_wrap">
            <button
              ...
              v-if="$check_action('/homestay_reservation/edit', 'add')"
              @click="to_form('/homestay_reservation/edit')"
            >
              <span> 预约</span>
            </button>
            <button
              class="btn btn-primary details_btn"
              v-if="$check_action('/homestay_information/details', 'set')"
              @click="change_praise()"
            >
              <span>点赞</span>
            </button>
