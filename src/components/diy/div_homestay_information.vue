<template>
	<div class="diy_details_box diy_div_homestay_information">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/homestay_reservation/edit','add')" @click="to_form('/homestay_reservation/edit')" ><span> 预约</span> </button>
																											<button class="btn btn-primary details_btn" v-if="$check_action('/homestay_information/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/homestay_information/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
				...
				if (this.state_collect) {
					...
					this.state_collect = true;
								query.title = this.obj.homestay_name
																	query.title = this.obj.homestay_room_type
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var homestay_information_id = this.obj.homestay_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "homestay_information",
          source_field: "homestay_information_id",
          source_id: homestay_information_id
        }, (res) => {
