      ...
      <el-row class="rows row2">
        <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
          <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button
              v-if="user_group == '管理员' || $check_action('/attraction_reservation/table', 'add') || $check_action('/attraction_reservation/view', 'add')"
      ...
      <el-table-column fixed="right" label="操作" min-width="120"
        ...
        <template slot-scope="scope">
          ...
          <el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;"
            size="small" @click="to_table(scope.row, '/tourist_attraction_ticket_refund/view')"
...
*/
    ...
    openPayModal(v) {
      ...
      window.open("http://localhost:5000/api/attraction_reservation/pay?subject=" + goods_name + "&traceNo=" + v.attraction_reservation_id + "&totalAmount=" + pay_money)
