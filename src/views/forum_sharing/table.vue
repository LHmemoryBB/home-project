				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 论坛分享 -->
							<div><span>论坛分享</span></div>
							<table_forum_sharing v-if="$check_action('/forum_sharing/table','get')"></table_forum_sharing>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_forum_sharing from "../../components/diy/table_forum_sharing.vue";
	export default {
		data() {
			return {
			};
