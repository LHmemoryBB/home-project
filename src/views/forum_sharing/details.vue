<template>
	<div class="diy_details page_forum_sharing" id="forum_sharing_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_forum_sharing'>
							<div_forum_sharing :obj="obj"></div_forum_sharing>
...
<script>
	import div_forum_sharing from "@/components/diy/div_forum_sharing.vue";
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.forum_sharing_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "forum_sharing",
					source_field: "forum_sharing_id",
					source_id: obj["forum_sharing_id"],
					user_id
				};
