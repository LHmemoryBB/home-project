				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_online_service v-if="$check_action('/online_service/view','get')"></view_online_service>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_online_service from "../../components/diy/view_online_service.vue";
	export default {
		data() {
			return {
			};
