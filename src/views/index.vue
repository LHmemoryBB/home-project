<template>
	<div class="page_root" id="root_demo">
		...
		<div class="warp article_s">
		    ...
		    <div class="container">
		        <div class="row">
					...
					<!-- 推荐景点信息模块(开始) -->
		<div class="ins warp model1" v-if="$check_action('/attraction_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/attraction_information/list" class="ins_more more">
		                ...
		                <!-- 景点信息推荐列表组件 -->
						<div class="list_attraction_information_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_attraction_information :list="list_attraction_information" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		<!-- 推荐景点信息模块(结束) -->
									<!-- 推荐美食信息模块(开始) -->
		<div class="ins warp model2" v-if="$check_action('/food_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/food_information/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 美食信息推荐列表组件 -->
						<div class="list_food_information_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_food_information :list="list_food_information" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		<!-- 推荐美食信息模块(结束) -->
						<!-- 推荐民宿信息模块(开始) -->
		<div class="ins warp model3" v-if="$check_action('/homestay_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/homestay_information/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 民宿信息推荐列表组件 -->
						<div class="list_homestay_information_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_homestay_information :list="list_homestay_information" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		<!-- 推荐民宿信息模块(结束) -->
								<!-- 推荐论坛分享模块(开始) -->
		<div class="ins warp model4" v-if="$check_action('/forum_sharing/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/forum_sharing/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 论坛分享推荐列表组件 -->
						<div class="list_forum_sharing_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_forum_sharing :list="list_forum_sharing" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		<!-- 推荐论坛分享模块(结束) -->
						<!-- 推荐积分商品模块(开始) -->
		<div class="ins warp model5" v-if="$check_action('/integral_products/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/integral_products/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 积分商品推荐列表组件 -->
						<div class="list_integral_products_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_integral_products :list="list_integral_products" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
...
<script>
	import mixin from "@/mixins/page.js";
			...
			import list_homestay_information from "@/components/diy/list_homestay_information.vue";
					import list_forum_sharing from "@/components/diy/list_forum_sharing.vue";
			import list_integral_products from "@/components/diy/list_integral_products.vue";
	...
	export default {
		...
		methods: {
			...
			toToggle(){
				this.isAdmin = !this.isAdmin;
						...
						// 获取景点信息列表
			get_attraction_information() {
				let url = "~/api/attraction_information/get_list?";
												let param = {
									"page": 1,
					"size": 12
				}
					...
					if (json.result) {
						this.list_attraction_information = json.result.list;
					}
				})
			},
								// 获取美食信息列表
				...
				let url = "~/api/homestay_information/get_list?";
					...
					if (json.result) {
						this.list_homestay_information = json.result.list;
							...
							// 获取论坛分享列表
			get_forum_sharing() {
				let url = "~/api/forum_sharing/get_list?";
												let param = {
					...
					"size": 12
						...
						this.$get(url, param, (json) => {
					if (json.result) {
						this.list_forum_sharing = json.result.list;
					}
				})
			},
					// 获取积分商品列表
			get_integral_products() {
				let url = "~/api/integral_products/get_list?";
												let param = {
									"page": 1,
					"size": 12
				}
						this.$get(url, param, (json) => {
					if (json.result) {
						this.list_integral_products = json.result.list;
					}
				})
			},
		...
		mounted() {
						this.get_attraction_information();
								this.get_food_information();
					this.get_homestay_information();
							this.get_forum_sharing();
					this.get_integral_products();
						this.get_menu();
			this.get_slides();
			this.get_article();
			this.get_notice();
		...
		computed: {
					    list_table_online_service() {
		        var list = this.list_attraction_information;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_attraction_information.map((o) => {
		                // 第二个中括号是对象的属性
		        ...
		        return list_table;
				    ...
				    list_table_online_service() {
		        var list = this.list_homestay_information;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_homestay_information.map((o) => {
		                // 第二个中括号是对象的属性
		                list_table[i][o] = list[i][o] || "";
		            });
		        }
		        return list_table;
						    ...
						    list_table_online_service() {
		        var list = this.list_forum_sharing;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_forum_sharing.map((o) => {
		                // 第二个中括号是对象的属性
		                list_table[i][o] = list[i][o] || "";
		            });
		        }
		        return list_table;
				    ...
				    list_table_online_service() {
		        var list = this.list_integral_products;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_integral_products.map((o) => {
		                // 第二个中括号是对象的属性
		                list_table[i][o] = list[i][o] || "";
		            });
		        }
