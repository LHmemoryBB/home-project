<template>
  <div
    class="diy_edit page_homestay_reservation"
    id="homestay_reservation_edit"
  >
    <div class="warp">
      <div class="container">
        <div class="row diy_edit_content_box">
          ...
          >
            ...
            <div class="diy_field diy_text">
              ...
              />
              <span v-else-if="$check_field('get', 'homestay_name')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
          ...
          >
            ...
            <div class="diy_field diy_text">
              ...
              />
              <span v-else-if="$check_field('get', 'homestay_address')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
          ...
          >
            ...
            <div class="diy_field diy_text">
              ...
              />
              <span v-else-if="$check_field('get', 'homestay_room_type')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
          ...
          >
            ...
            <div class="diy_field diy_number">
              ...
              />
              <span v-else-if="$check_field('get', 'homestay_prices')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
              ...
              <el-input
                ...
                v-if="
                  ...
                  (!form['appointment_quantity'] &&
                    $check_field('add', 'appointment_quantity'))
                "
                @input="set_appointment_amount()"
                :disabled="disabledObj['appointment_quantity_isDisabled']"
              />
              <span v-else-if="$check_field('get', 'appointment_quantity')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
          ...
          >
            ...
            <div class="diy_field diy_number">
              ...
              />
              <span v-else-if="$check_field('get', 'appointment_days')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
          ...
          >
            ...
            <div class="diy_field diy_text">
              ...
              />
              <span v-else-if="$check_field('get', 'appointment_remarks')">{{
                form["${obj.name}"]
              }}</span>
            </div>
          </div>
  ...
  methods: {
    ...
    set_appointment_amount() {
      if (this.form.appointment_days && this.form.appointment_quantity) {
        ...
        console.log(this.form.appointment_amount);
        let r = /^\+?[1-9][0-9]*$/; // 正整数
        if (!r.test(this.form.appointment_amount)) {
          this.form.appointment_amount =
    ...
    change_file(files, str) {
      ...
      this.$post("~/api/homestay_reservation/upload?", form, (res) => {
        if (res.result) {
