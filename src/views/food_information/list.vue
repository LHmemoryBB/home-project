					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																							<b-form-input size="sm" class="mr-sm-2" placeholder="美食名称搜索" v-model="query['food_name']" />
																														<b-form-input size="sm" class="mr-sm-2" placeholder="美食分类搜索" v-model="query['food_classification']" />
				...
				<div class="diy_list_select_box">
					<span class="diy_list_select_title">下拉搜索：</span>
						...
						<div class="col">
							<!-- 筛选 -->
							<div class="view sift">
															<b-dropdown text="美食分类" variant="outline-dark" left>
									<b-dropdown-item @click="filter_set('全部','food_classification')">全部</b-dropdown-item>
										<b-dropdown-item v-for="(o, i) in list_food_classification" :key="i" @click="filter_set(o['food_classification'],'food_classification')" >
