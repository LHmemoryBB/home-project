<template>
	<div class="diy_details page_homestay_information" id="homestay_information_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_homestay_information'>
							<div_homestay_information :obj="obj"></div_homestay_information>
...
<script>
	import div_homestay_information from "@/components/diy/div_homestay_information.vue";
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.homestay_information_id;
				}
			},
			/**
			 * 初始化收藏状态
