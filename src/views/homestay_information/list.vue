<template>
	<div class="diy_list page_homestay_information" id="homestay_information_list">
		<div class="warp">
					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																							<b-form-input size="sm" class="mr-sm-2" placeholder="民宿名称搜索" v-model="query['homestay_name']" />
																														<b-form-input size="sm" class="mr-sm-2" placeholder="民宿地址搜索" v-model="query['homestay_address']" />
																														<b-form-input size="sm" class="mr-sm-2" placeholder="民宿房型搜索" v-model="query['homestay_room_type']" />
