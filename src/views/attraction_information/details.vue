<template>
	<div class="diy_details page_attraction_information" id="attraction_information_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_attraction_information'>
							<div_attraction_information :obj="obj"></div_attraction_information>
...
<script>
	import div_attraction_information from "@/components/diy/div_attraction_information.vue";
		...
		methods:{
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.attraction_information_id;
				}
			},
			/**
			 * 初始化收藏状态
